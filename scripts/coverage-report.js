 ...
 *
 * This is the artifact that answers the taxonomy request. It is generated rather
 * than hand-written so it stays true as the catalog changes.
 *
 * Usage:
...
const { classify } = require('./lib/dnb-mapping')
const { CHANNELS } = require('./lib/channels')
const { EVIDENCE } = require('./lib/dnb-technologies')

const ROOT = path.resolve(__dirname, '..')
const REQUEST_FILE = path.join(ROOT, 'data/dnb-request.json')
